    ...
    <div>
      <Container className="min-h-screen">
        ...
        <div className=" px -30 mx-auto prose max-w-2xl">
          <h1 className="text-4xl gradient-to-r from-indigo-500 via-purple-500 to-pink-500 font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
            Software Developer, UX Researcher, and a Musicphile.
          </h1>
          <div className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            <span className="text-xl pb-0 ">
              I’m Collins , a skilled developer with expertise in
              .NET, databases, JavaScript, Python and designer adept
              at contributing to highly collaborative work
            ...
            <br />
            <br />
            <p className=" pt-5px text-italics">
          ...
          <div className="mt-6  mb-10  flex gap-6">
            <a
              ...
              href="https://twitter.com/tckiprotich">
              <svg
                viewBox="0 0 24 24"
                aria-hidden="true"
            ...
            <a
              ...
              href="https://instagram.com/tckiprotich">
              <svg
                viewBox="0 0 24 24"
                aria-hidden="true"
                className="h-6 w-6 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300">
            ...
            <a
              ...
              href="https://linkedin.com/in/collins-tonui">
              <svg
                viewBox="0 0 24 24"
                aria-hidden="true"
                className="h-6 w-6 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300">
