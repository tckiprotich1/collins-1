...
export default function Navbar(props) {
  ...
  return (
    <div>
      ...
      <div class="max-w-5xl pb-20 mx-auto flex flex-wrap p-5 flex-col md:flex-row">
        ...
        >
          <div class="md:ml-auto md:mr-auto font-4 pt-1 md:pl-14 pl-1 flex flex-wrap items-center md:text-base text-1xl md:justify-center justify-items-start">
            <a href="/archive" class="mr-11 pr-2 cursor-pointer text-gray-300 hover:text-white font-semibold tr04">
              Blog
            </a>
            <div className="relative">
              ...
              >
                <span className="tr04">Portfolio</span>
                <svg
                  className={
                    flyer === true
              ...
              >
                <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                  <div className="relative grid gap-6 bg-black px-2 py-6 sm:gap-8 ">
                    <a
                      href="https://www.reddit.com/user/IPhurts"
                    ...
                    <a
                      href="https://api.whatsapp.com/send/?phone=%2B254796250508&text&type=phone_number&app_absent=0"
                      className="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-800 tr04"
                    >
                      <div className="ml-4">
                        <p className="text-base font-medium text-white">
